...
const sharedInvitation = {
  ...
  copy: {
    invitation:
      'Мы будем счастливы разделить с вами один из самых важных и счастливых дней нашей жизни, который мы выбрали для нашего союза, — 10 октября. Приглашаем вас стать частью этого праздника, наполненного любовью, радостью и тёплыми воспоминаниями.',
    dressCode:
...
const friendsTimeline = [
  ...
  },
  {
    ...
    location: {
      ...
      details: 'О трансфере мы позаботимся сами, с вас — полотенца, купальники, тапочки.',
      addTopBreak: true,
    },
    description: '',
  },
